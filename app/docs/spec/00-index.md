...
- **Current package:** IMP-012 foundational RLS (IMPLEMENTED 2026-09-01; acceptance checks green; awaiting human approval and Git checkpoint — security-critical per `12`)
- **Completed packages:** IMP-010 tenant core schema (COMPLETE — checkpoint `c913b9d`); IMP-011 staff authentication (COMPLETE — checkpoint `8ea9c4a`)
- **Next package:** IMP-013 (blocked until the IMP-012 human approval + checkpoint and a separate explicit implementation instruction)
