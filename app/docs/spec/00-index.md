...
- **Next package:** IMP-050 — Recurrence generation & scheduler signals (NOT STARTED — awaits the explicit implementation prompt; entry criteria per `12-release-0-plan.md`: R0-D green — satisfied; AUTO-OQ-01/02 technical validation recorded in `09` — NOT yet resolved)
