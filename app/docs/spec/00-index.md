...
- **Current package:** IMP-021 engagements (IMPLEMENTED 2026-09-02; acceptance checks green; awaiting human approval and Git checkpoint)
...
- **Next package:** IMP-022 Client 360 (blocked until the IMP-021 human approval + checkpoint and a separate explicit implementation instruction)
