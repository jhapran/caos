...
- **Relationships:** N—1 LegalEntity; N—1 ComplianceType; N—1 Registration (nullable); 1—N Task, DocumentRequest; N—1 assignee/reviewer (FirmMembership); successor link to the next-period instance (recurrence, PRD §29).
