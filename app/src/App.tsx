...
export default function App() {
  return (
    <Routes>
      ...
      >
        <Route path="/brief" element={<ModuleGate title="Morning Brief" detail="The partner brief is composed from compliance, task and alert data that arrives with the Compliance Engine release."><MorningBrief /></ModuleGate>} />
        <Route path="/command" element={<ModuleGate title="Command Centre" detail="Firm-wide operational sections arrive with the Compliance Engine and workflow releases."><CommandCentre /></ModuleGate>} />
        <Route path="/clients" element={<ClientsPage />} />
        <Route path="/clients/:clientId" element={<Client360Page />} />
        <Route path="/deadlines" element={<ModuleGate title="Deadlines" detail="Statutory deadlines are generated by the Compliance Engine, which arrives in a later release."><Deadlines /></ModuleGate>} />
