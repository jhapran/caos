...
export const ASK_FIXTURES: AskAnswer[] = [
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['LMN Ltd', 'Aug 2025', '20 Sep 2025', 'Ready to File', 'CA Pranav Sharma'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['LMN Ltd', 'GSTR-3B', 'Aug 2025', '20 Sep 2025', 'CA Pranav Sharma'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['Critical', '9 tax audits due 30 Sep', 'CA Pranav Sharma', 'Rebalance workload across team'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['CA Pranav Sharma', '128', '18', '1', 'Reviews only'],
      ],
    },
...
export const FALLBACK_ANSWER: Omit<AskAnswer, 'question'> = {
  ...
  table: {
    ...
    rows: [
      ...
      ['LMN Ltd', 'Advance Tax', '15 Sep 2025', 'Waiting for Client', 'CA Pranav Sharma'],
