...
export const ASK_FIXTURES: AskAnswer[] = [
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['LMN Ltd', 'Aug 2025', '20 Sep 2025', 'Ready to File', 'CA Lew Kong'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['LMN Ltd', 'GSTR-3B', 'Aug 2025', '20 Sep 2025', 'CA Lew Kong'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['Critical', '9 tax audits due 30 Sep', 'CA Lew Kong', 'Rebalance workload across team'],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ['CA Lew Kong', '128', '18', '1', 'Reviews only'],
      ],
    },
...
export const FALLBACK_ANSWER: Omit<AskAnswer, 'question'> = {
  ...
  table: {
    ...
    rows: [
      ...
      ['LMN Ltd', 'Advance Tax', '15 Sep 2025', 'Waiting for Client', 'CA Lew Kong'],
